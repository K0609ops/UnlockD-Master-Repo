        ...
        {mode === 'login' && (
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            <button
              ...
              title={!firebaseEnabled ? 'Add Firebase keys to .env to enable Google sign-in' : undefined}
              className="w-full flex items-center justify-center gap-3 bg-paper border border-line py-3 rounded-xl font-medium hover:bg-line/20 transition-colors mb-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {googleLoading ? (
